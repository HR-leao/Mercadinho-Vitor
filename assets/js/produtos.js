...
let produtosJson = [
    ...
    { id: 6, name: ' Império', img: 'assets/images-Produtos/imperio.png', price: 10, size: [], description: 'Cerveja' },
    { id: 7, name: ' Antártica', img: 'assets/images-Produtos/antartica.png', price: 10, size: [], description: 'Cerveja' },
